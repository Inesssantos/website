...
open1.addEventListener('click', ()=>{
    modalContainer1.classList.add('modal-show');
    console.log('open')
})

close1.addEventListener('click', ()=>{
    modalContainer1.classList.remove('modal-show');
})

//modal 2
const open2 = document.getElementById('modal-open2');
const modalContainer2 = document.getElementById('modal-container2');
const close2 = document.getElementById('modal-close2');

open2.addEventListener('click', ()=>{
    modalContainer2.classList.add('modal-show');
    console.log('open')
})

close2.addEventListener('click', ()=>{
    modalContainer2.classList.remove('modal-show');
})

//modal 3
const open3 = document.getElementById('modal-open3');
const modalContainer3 = document.getElementById('modal-container3');
const close3 = document.getElementById('modal-close3');

open3.addEventListener('click', ()=>{
    modalContainer3.classList.add('modal-show');
    console.log('open')
})
